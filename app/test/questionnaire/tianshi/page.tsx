...
const questions = [
  {
    ...
    subtitle: '你的作息习惯',
    options: [
      { value: 3, label: 'EARLY BIRD', desc: '早起型，清晨即起' },
      { value: 2, label: 'FLEXIBLE', desc: '随性型，没有固定规律' },
      { value: 1, label: 'NIGHT OWL', desc: '夜猫子，晚睡晚起' },
    ],
  },
  {
    id: 'energy',
    ...
    subtitle: '你的精力状态',
    options: [
      { value: 3, label: 'ENERGETIC', desc: '精力充沛，活力满满' },
      { value: 2, label: 'MODERATE', desc: '精力适中，张弛有度' },
      { value: 1, label: 'RELAXED', desc: '容易疲惫，需要休息' },
    ],
  },
];
    ...
    <main className="min-h-screen bg-[var(--background)] text-[var(--primary)]">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[var(--background)]/90 backdrop-blur-sm border-b border-[var(--sand)]">
        <div className="flex items-center justify-between px-6 md:px-12 py-6">
          ...
          <span className="text-xs tracking-[0.2em] text-[var(--text-muted)]"><span className="font-en"><span className="font-en">02 / 06</span></span></span>
        </div>
      </nav>
        ...
        <div className="max-w-2xl mx-auto w-full">
          ...
          >
            <div className="flex items-center gap-4">
              <span className="text-xs tracking-[0.2em] text-[var(--text-muted)]"><span className="font-en">Step 02</span></span>
              <span className="text-xs tracking-[0.2em] text-[var(--accent)] font-medium">TIANSHI · 天时</span>
            </div>
